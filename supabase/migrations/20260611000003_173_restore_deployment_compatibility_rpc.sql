-- Restore the deployment compatibility RPC if an earlier migration was
-- recorded without leaving the function present in the public schema.
...
comment on function public.assert_deployment_compatibility(integer) is
  'Fails when the database deployment version is older than the required frontend version.';
