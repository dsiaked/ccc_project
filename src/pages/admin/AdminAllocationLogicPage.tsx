...
const allocationLogicOptions = [
  ...
  },
  {
    ...
    badge: '전체 수요 운송',
    summary:
      '모든 1지망 수요를 태울 수 있고 차량당 최소 인원을 충족한 추천안 중 총 버스 대여비가 낮은 안을 우선합니다.',
    priority: ['총 대여비 낮음', '빈 좌석 적음', '차량 수 적음'],
    formula: '정렬 = 총 버스 대여비 -> 빈 좌석 -> 차량 수',
    goodFor:
      '모든 1지망 신청자를 배차하면서 승인받을 총 대여비를 최대한 줄여야 할 때',
    caution:
      '비용이 가장 낮은 안도 여러 도착역을 한 차량으로 경유하거나 여유 좌석이 적을 수 있습니다.',
  },
];
      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.ruleGrid}>
            ...
            <article>
              <GitMerge size={20} />
              <strong>차량당 최소 36명</strong>
              <p>
                35명 이하 차량은 탑승자 전원을 수용할 빈 좌석이 있는 다른
                차량으로 통합합니다. 통합된 차량은 여러 도착역을 경유할 수
                있습니다.
              </p>
            </article>
            <article>
              <ListOrdered size={20} />
              <strong>최소 인원을 못 채우면 제외</strong>
              <p>
                차량 통합 후에도 36명 미만인 차량이 하나라도 남는 추천안은
                보여주지 않습니다. 배차 가능한 안이 없으면 차량 옵션이나
                도착역 안내 기준을 조정해야 합니다.
              </p>
            </article>
          </div>
        ...
        <section className={styles.section}>
          ...
          <ol className={styles.stepList}>
            ...
            <li>
              <strong>35명 이하 차량 통합</strong>
              <p>
                탑승 인원이 가장 적은 차량부터 전체 인원을 수용할 수 있는 다른
                차량으로 합칩니다. 이 단계에서 한 차량이 여러 도착역을 경유할
                수 있습니다.
              </p>
            </li>
            <li>
              ...
              <p>
                통합 후 모든 차량이 36명 이상인 안만 남기고, 선택한 옵션의
                우선순위에 따라 최대 5개 추천안을 보여줍니다.
              </p>
            </li>
          </ol>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.decisionGrid}>
            ...
            <article>
              <strong>기존 확정 버스표 보호</strong>
              <p>
                이미 확정된 신청자는 변경하지 않습니다. 각 차량의 기존 확정
                좌석 번호를 제외하고 남은 좌석 번호부터 자동으로 부여합니다.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.decisionGrid}>
            <article>
              <strong>다중 도착역 차량을 확인합니다</strong>
              <p>
                최소 36명 규칙으로 통합된 차량은 경유 도착역이 여러 개일 수
                있습니다. 출발 전 운행 경로와 신청자 안내를 확인해야 합니다.
              </p>
            </article>
            <article>
