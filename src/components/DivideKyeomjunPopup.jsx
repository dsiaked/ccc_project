...
import DivideKyeomjunContent from '../data/artworkContent/divideKyeomjun';
...
export default function DivideKyeomjunPopup({ onClose, language = 'ko' }) {
  ...
  const englishCopy = language === 'en' ? artistPopupEnglish.divide_kyeomjun : null;
  const commentsApi = useArtworkComments('divide_kyeomjun');
