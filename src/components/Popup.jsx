    ...
    <Suspense fallback={<PopupLoading language={language} />}>
      ...
      {activeArtistId && onToggleLanguage && (
        <LanguageToggle
          ...
          tone="dark"
          className="fixed left-[calc(50%-176px)] top-2 z-[120] flex h-10 items-center gap-1.5 rounded-full border border-white/75 bg-slate-950/82 px-3 text-xs font-bold text-white shadow-[0_10px_28px_rgba(15,23,42,0.28)] backdrop-blur transition active:scale-95"
        />
      )}
    </Suspense>
  );
