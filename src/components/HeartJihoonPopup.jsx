...
import HeartJihoonContent from '../data/artworkContent/heartJihoon';
...
export default function HeartJihoonPopup({ onClose, language = 'ko' }) {
  ...
  const englishCopy = language === 'en' ? artistPopupEnglish.heart_jihoon : null;
  const commentsApi = useArtworkComments('heart_jihoon');
