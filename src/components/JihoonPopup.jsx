...
export default function JihoonPopup({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      <div className="relative w-[360px] h-[780px] max-h-[92vh] rounded-[32px] overflow-hidden flex flex-col shadow-[0_25px_60px_rgba(0,0,0,0.18)] border border-gray-100 bg-white animate-in zoom-in-95 duration-300">
        ...
        {step === 1 && (
          <div className="relative flex-1 bg-gradient-to-b from-[#ffffff] via-[#fffbfb] to-[#fff0f0] text-gray-800 overflow-hidden select-none">
            ...
            <div className="relative z-10 w-full h-full">
              ...
              {/* 2026.05.26/06.02 */}
              <div className="absolute right-[25px] top-[31px] text-[10px] text-[#4a3b3b] tracking-[1.2px] text-right font-readable-sans">
                2026.05.26/06.02
              </div>

              {/* 과기대 붕어방 */}
              <div className="absolute right-[25px] top-[44px] text-[10px] text-[#4a3b3b] tracking-[1.2px] text-right font-readable-sans">
                과기대 붕어방
              </div>
        ...
        {step === 2 && (
          <div className="relative flex-1 flex flex-col bg-gradient-to-b from-[#ffffff] via-[#fffbfb] to-[#ffebeb] text-gray-800 overflow-y-auto popup-body-scroll select-none">
            ...
            <div className="relative w-full flex flex-col p-6 pb-8 min-h-[1150px]">
              ...
              <div className="relative z-10 flex-1 flex flex-col bg-white/80 backdrop-blur-md rounded-[20px] border border-rose-100 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.03)]">
                ...
                <div className="text-left text-[14px] leading-[1.85] text-gray-700 space-y-5 tracking-wide font-readable-sans select-text">
                  <p className="text-gray-800 font-medium">잔디 위에 놓인 유리병은</p>
                  <p className="text-gray-800 font-medium">바람에 아주 조금씩 흔들리고 있었다.</p>
                  <p>그 안에는 하트 모양으로 접힌 종이들이</p>
                  <p>가득 담겨 있었다.</p>

                  <div className="h-1" />
                  <p>누군가는 그걸 사랑이라고 불렀고,</p>
                  <p>누군가는 그걸 위로라고 불렀다.</p>
                  ...
                  <div className="h-1" />
                  <p>그저 누군가에게 건네고 싶었지만,</p>
                  <p>쉽게 말로 꺼내지 못했던 마음들이었다.</p>
                  ...
                  <p>햇살이 내려앉을 때마다</p>
                  <p>유리병 속 하트들은 따뜻하게 빛났다.</p>
                  <p className="font-bold text-rose-600">마치 그 안에 담긴 말들이</p>
                  <p className="font-bold text-rose-600">이제는 괜찮다고, 괜찮아질 거라고</p>
                  <p className="font-bold text-rose-600">조용히 속삭이는 것처럼.</p>

                  <div className="h-1" />
                  <p>지나가던 사람들 중 누군가는</p>
                  <p>잠시 멈춰 서서 그 병을 바라봤다.</p>
                  <p>그리고 이유 없이 마음이 조금 가벼워졌다.</p>

                  <div className="h-1" />
                  <p>아마도 그건, 그 안의 말들이 특별해서가 아니라</p>
                  <p className="font-semibold text-rose-700">누군가가 누군가를 위해 이만큼</p>
                  <p className="font-semibold text-rose-700">마음을 접어 넣었다는 사실 때문일 것이다.</p>
                  ...
                  <div className="pl-3.5 border-l-2 border-rose-300 text-[12.5px] text-gray-800 leading-relaxed bg-[#fffafa] p-4 rounded-3xl border border-rose-100">
                    사랑은 거창한 게 아니라 이렇게 작게 접어도 충분하고,<br />
                    위로는 멀리 있는 게 아니라 이렇게 가까이 놓여 있어도 된다는 걸.
                  </div>
                  ...
                  <p>잔디 위의 유리병은 오늘도 아무 말 없이 서 있지만,</p>
                  <p>그 안의 수많은 하트들은 계속해서 말하고 있다.</p>
