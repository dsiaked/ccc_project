              ...
              <div className="relative z-10 flex-1 flex flex-col bg-white/80 backdrop-blur-md rounded-[20px] border border-green-100 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.03)]">
                ...
                <div className="text-left text-[14.5px] leading-[1.85] text-gray-700 space-y-5 tracking-wide font-readable-sans select-text break-keep">
                  ...
                  <p className="text-gray-800">
                    바닥에 굴러다니는 금 간 플라스틱 조각, 녹이 슨 나사, 버려진 과자봉지 같은 것들.<br />
                    사람들은 그런 물건들을 보아도 의미를 느끼지 못했다.
                  </p>

                  <div className="h-1" />
                  <p className="text-gray-800">
                    그런데 한 사람만은 달랐다.<br />
                    그는 길가에 버려진 물건들을 그냥 지나치지 못했다.<br />
                    남들에게는 하찮아 보일지 몰라도, 오래 닳은 자국과 깨진 모서리,<br />
                    버려진 것 안에는 분명 누군가의 시간이 남아 있다고 생각했기 때문이다.<br />
                    손때가 남은 표면, 바랜 색, 무뎌진 끝에는 오랫동안 사용되었던 흔적이 있었다.
                  </p>

                  <div className="h-1" />
                  <p className="font-semibold text-green-700">
                    그래서 그는 그런 물건들을 하나씩 주워오기 시작했다.<br />
                    그리고 가장 소중한 것을 다루듯 작은 유리 돔 안에 넣어 보호했다.<br />
                    아무도 함부로 만지지 못하도록, 더 이상 버려지지 않도록 조심스럽게 감싸 두었다.
                  </p>

                  <div className="py-2 text-green-300 text-center flex justify-center gap-1 select-none font-bold">
                    <span>.</span><span>.</span><span>.</span>
                  </div>

                  <p className="text-gray-850">
                    시간이 지나자 이상한 일이 생겼다.<br />
                    돔 안의 물건들은 그대로였지만, 바깥의 유리에는 조금씩 상처가 늘어나기 시작한 것이다.<br />
                    희미한 긁힘, 금이 간 자국, 깨져버린 모서리들.<br />
                    마치 안의 물건 대신 유리가 상처를 받아내고 있는 것처럼 보였다.
                  </p>
                  ...
                  <p className="text-gray-800">
                    하지만 그는 알고 있었다.<br />
                    쉽게 버려지는 것들은, 그만큼 쉽게 상처받는 존재들이라는 걸.
                  </p>
                  ...
                  <div className="my-6 border border-green-150 bg-[#f1faf2] py-5 px-3.5 rounded-3xl font-sentiment text-[14.5px] leading-relaxed text-[#2e7d32] text-center shadow-sm">
                    <p className="font-bold text-[#2d6630]">세상이 가치 없다고 말하는 것들조차,</p>
                    <p className="font-bold text-[#2d6630]">누군가에게는 아주 소중할 수 있다.</p>
                  </div>
