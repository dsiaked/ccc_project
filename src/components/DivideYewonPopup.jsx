...
import { X, ArrowRight, ArrowLeft, Divide, Check, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      <div className="relative w-[360px] h-[780px] max-h-[92vh] rounded-[32px] overflow-hidden flex flex-col shadow-[0_25px_60px_rgba(0,0,0,0.18)] border border-gray-100 bg-white animate-in zoom-in-95 duration-300">
            ...
            <div className="relative z-10 w-full h-full">
              ...
              <div className="absolute left-[26px] right-[25px] top-[492px] flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-50 border border-orange-100 hover:bg-orange-100/50 text-[#f97316] cursor-pointer transition-all active:scale-95 shadow-sm animate-in fade-in duration-300"
                  title="감상평 남기기"
                >
        ...
        {step === 2 && (
          <div className="relative flex-1 flex flex-col bg-gradient-to-b from-[#ffffff] via-[#fffbf7] to-[#fff4eb] text-gray-800 overflow-y-auto popup-body-scroll select-none">
              ...
              <div className="relative z-10 flex-1 flex flex-col bg-white/80 backdrop-blur-md rounded-[20px] border border-orange-100 p-7 shadow-[0_8px_32px_rgba(0,0,0,0.03)]">
                ...
                <div className="text-left text-[14px] leading-[1.85] text-gray-700 space-y-5 tracking-wide font-readable-sans select-text">
                  ...
                  <div className="my-6 border border-orange-150 bg-[#fffaf0] py-5 px-3.5 rounded-3xl font-sentiment text-[14.5px] leading-relaxed text-[#c2410c] text-center shadow-sm">
                    <p className="font-bold text-[#b43e0e]">“세상 속에서 돋아난 나의 가시로 인해 나누어진 모든 것을</p>
                    <p className="font-bold text-[#b43e0e]">‘그럼에도 불구하고’ 이어내는 사랑이 무엇인지.”</p>
                  </div>
            ...
            <div className="flex-1 overflow-y-auto popup-body-scroll my-3 pr-1 space-y-3 select-text">
              {loadingComments ? (
                ...
                comments.map((comment) => (
                  <div key={comment.id} className="bg-orange-50/30 border border-orange-100/50 p-3 rounded-2xl flex flex-col gap-1 shadow-sm">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-xs text-orange-800">{comment.name}</span>
